function [total_number_of_replica,total_relability,R,processor_available,num,replica_matrix,deadline_slack,est,drt,aft,processor_avail] = DL_LBR_algorithm_c()
format long;
...
for i=1:1:n
  ...
  while(R(i)< Rlb_req(i) && flag_task==0 )
      ...
      for j=1:1:number_of_processors
          ...
          if (processor_available(i,j)==0)
                ...
                flag_eft = est(i,j)+ W(i,j);
                  ...
                  if (replica_relability >= Rlb_req(i) && max_relability < replica_relability)
                   ...
                   flag_task=1;
                   break;
                  else if(replica_relability < Rlb_req(i) && processor_available(i,j)==0 && replica_relability >= max_replica && flag_relability==0 )
      ...
      deadline_slack = flag_one_replica_eft; 
      num(i)= num(i)+1;
      else
      ...
      deadline_slack = flag_max_replica_eft;
      num(i)= num(i)+1;
      end
  end
