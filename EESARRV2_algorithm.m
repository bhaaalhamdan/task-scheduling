...
function [R_req,total_relability,total_number_of_replica,num,frequency_result_matrix,final_replica_relability_matrix ,R,total_dynmic_power_consumed, result_replica_power,task_power_consumed] = EESARRV2_algorithm()
format long;
% timer for execution time calculation
...
[~,~,~,~,fk_max,fk_low,fr_u] = power_input_function(number_of_processors);
